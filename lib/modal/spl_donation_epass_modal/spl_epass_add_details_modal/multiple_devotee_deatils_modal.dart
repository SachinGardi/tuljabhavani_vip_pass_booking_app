class MultipleDevoteeDetailsModal {
  int? id;
  int? devoteeId;
  String? devoteeName;
  String? mobileNo;
  ...
  factory MultipleDevoteeDetailsModal.fromJson(Map<String, dynamic> json) => MultipleDevoteeDetailsModal(
      id: json["id"],
