...
class PaymentGatewayPassView extends StatefulWidget {
  const PaymentGatewayPassView({Key? key}) : super(key: key);

  @override
  State<PaymentGatewayPassView> createState() => _PaymentGatewayPassViewState();
}
class _PaymentGatewayPassViewState extends State<PaymentGatewayPassView> {
